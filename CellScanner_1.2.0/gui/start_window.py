...
class MainWindow(QMainWindow):
    ...
    def __init_widgets(self) -> None:
        ...
        version = Label(text="Version 1.1\nC. Joseph", obj_name="version", geometry=[0, 531, 895, 58], parent=self)
        [label.setAlignment(Qt.AlignmentFlag.AlignCenter) for label in [tittle, version]]
        Button(text="Prediction", obj_name="main", geometry=[12, 91, 215, 425], parent=self)
        Button(text="Training", obj_name="main", geometry=[232, 91, 215, 425], parent=self)
        Button(text="Settings", obj_name="main", geometry=[452, 91, 215, 425], parent=self)
        Button(text="Help", obj_name="main", geometry=[672, 91, 215, 425], parent=self)
